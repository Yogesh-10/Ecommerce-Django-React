...
# types, after first validating the incoming data. also to generate auth tokens 
...
# nesting all data to Order Model and return nesting object in json and fetch it in frontend
